...
class Agent():
    ...
    def __init__(self, state_shape, action_size, num_agents, buffer_size, batch_size, gamma, tau, learning_rate_actor, learning_rate_critic, device, update_every=1, random_seed=42):
        ...
        # Replay memory
        self.memory = ReplayBuffer(action_size, buffer_size, batch_size, device=device, seed=random_seed)
