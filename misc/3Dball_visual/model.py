...
class Actor(nn.Module):
    ...
    def __init__(self, action_size, seed, c1_filters=16, c2_filters=32, fc1_units=128):
    ...
    def reset_parameters(self):
        self.c1.weight.data.uniform_(*hidden_init(self.c1))
        self.c2.weight.data.uniform_(*hidden_init(self.c2))
        self.c3.weight.data.uniform_(*hidden_init(self.c3))
...
class Critic(nn.Module):
    ...
    def __init__(self, action_size, seed, c1_filters=16, c2_filters=32, fc1_1_units=128, fc1_2_units=16, fc2_units=16):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
    ...
    def reset_parameters(self):
        ...
        self.c2.weight.data.uniform_(*hidden_init(self.c2))
        self.c3.weight.data.uniform_(*hidden_init(self.c3))
        self.fc1_1.weight.data.uniform_(*hidden_init(self.fc1_1))
