...
class Agent():
    ...
    def __init__(self, state_shape, action_size, buffer_size, batch_size, gamma, tau, learning_rate, update_every, seed):
        ...
        self.optimizer = tf.keras.optimizers.RMSprop(learning_rate=0.00025, momentum=0.95)
